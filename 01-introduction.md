...
'''
🔹 ما هو __file__ ؟
__file__ هو متغير خاص في
Python
ويحتوي على المسار الكامل لملف السكربت الحالي.

🔹 ماذا يفعل Path(__file__).name ؟
نستخدم Path من مكتبة pathlib لاستخراج اسم الملف فقط بدون المسار.
...
for filepath in current_dir.iterdir():         # iterdir(): liefert alle Dateien und Unterordner in diesem Verzeichnis
